...
import 'package:e_bill/user_panel/user_dashboard/domain_layer.dart/get_present_month_record.dart';
import 'package:e_bill/user_panel/user_dashboard/domain_layer.dart/present_month_year.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              :
              FutureBuilder(
                future: getPreviousMonthRecord(previousMonthYear: "${allMonths[DateTime.now().month - 1]}_${DateTime.now().year}", user: widget.user!),
                builder: (context, snapshot){
                  ...
                  if(true){
                    final previousMonthRecord = snapshot.data as MonthlyRecord?;
                    return Expanded(
                      flex: 30,
                      child: SizedBox(
                        child: Column(
                                              ...
                                              Column(
                                                children: [
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                  padding: const EdgeInsets.all(8.0),
                                                  child: Text(monthYearString(DateTime.now()),style: const TextStyle(color: Colors.black45, fontSize: 19),),
                                                ),
                                                  ),
                                                  Padding(
                                                    padding: const EdgeInsets.all(8.0),
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Text((previousMonthRecord != null)? previousMonthRecord.usedunit.toString() : "0", style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 19),),
                                                            ))
                                                        ],
                                                      )
                                                    ),
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Padding(
                                                              padding: const EdgeInsets.symmetric(horizontal: 16),
                                                              child: Text((previousMonthRecord != null)? previousMonthRecord.finaltotalTk.toString() : "0", style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 19),),
                                                            ))
                                                        ],
                                                      )
                                                    ),
