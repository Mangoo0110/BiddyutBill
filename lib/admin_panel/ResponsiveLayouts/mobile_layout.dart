      ...
      drawer: Drawer(
        ...
        child: Column(
          children: [
            ...
            ListTile(
              tileColor:
                  (_index == 0) ? Colors.green.shade300 : Colors.transparent,
              leading: const Icon(
                Icons.home_work,
              ),
            ...
            ListTile(
              tileColor:
                  (_index == 1) ? Colors.green.shade300 : Colors.transparent,
              leading: const Icon(
            ...
            ListTile(
              tileColor:
                  (_index == 2) ? Colors.green.shade300 : Colors.transparent,
              leading: const Icon(
            ...
            ListTile(
              tileColor:
                  (_index == 3) ? Colors.green.shade300 : Colors.transparent,
              leading: const Icon(
